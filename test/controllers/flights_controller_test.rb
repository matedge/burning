...
class FlightsControllerTest < ActionController::TestCase
  ...
  test "should create flight" do
    assert_difference('Flight.count') do
      post :create, flight: { date: @flight.date, destination: @flight.destination, origin: @flight.origin }
    end
  ...
  test "should update flight" do
    patch :update, id: @flight, flight: { date: @flight.date, destination: @flight.destination, origin: @flight.origin }
    assert_redirected_to flight_path(assigns(:flight))
  end
